...
import org.seke.filmanias.domain.RoleProperties.RoleProperty;

/**
 * This generated interface defines property names for all
 * attributes and associatations in
 * {@link org.seke.filmanias.domain.User}.
 * <p>
...
public class UserProperties {
    ...
    public static Property<User> eMail() {
        return sharedInstance.eMail();
    }
    ...
    /**
     * This class is used for references to {@link org.seke.filmanias.domain.User},
     * i.e. nested property.
     */
    ...
    protected static class UserPropertiesImpl<T> extends PropertiesCollection {
        ...
        public Property<T> eMail() {
            return new LeafProperty<T>(getParentPath(), "eMail", false,
                owningClass);
        }
